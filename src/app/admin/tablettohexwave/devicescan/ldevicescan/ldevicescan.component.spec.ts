...
import { LdevicescanComponent } from "./ldevicescan.component";
...
describe('LdevicescanComponent', () => {
    let component: LdevicescanComponent;
    let fixture: ComponentFixture<LdevicescanComponent>;
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            declarations: [LdevicescanComponent],
            imports: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(LdevicescanComponent);
    ...
    it('should call the openLeftDevice method', () => {
        component.openLeftDevice();
        expect(component.openLeftDevice).toBeTruthy();
    });
