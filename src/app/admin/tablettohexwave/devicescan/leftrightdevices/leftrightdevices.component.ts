...
@Component({
  selector: 'app-leftrightdevices',
  templateUrl: './leftrightdevices.component.html',
  styleUrls: ['./leftrightdevices.component.scss']
})
export class LeftrightdevicesComponent implements OnInit {
