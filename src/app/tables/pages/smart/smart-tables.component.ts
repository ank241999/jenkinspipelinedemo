...
// Table 1 - external filters
  ...
  @ViewChild('paginatorTable1', { static: true }) paginatorTable1: MatPaginator;
...
// Table 2 - local filters
  ...
  @ViewChild('paginatorTable2', { static: true }) paginatorTable2: MatPaginator;
  @ViewChild('sortTable2', { static: true }) sortTable2: MatSort;
